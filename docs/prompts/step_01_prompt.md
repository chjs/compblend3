...
이 파일은 Step 1 (fork 동치성 검증) 작업의 시작 프롬프트와
...
Step 0 완료(merge·tag `step_00_done`) 후 Step 1 진입. `tasks/step_01_fork_equivalence.md`는
...
6. **vast.ai 실행**: instance 36787683 할당 → 셋업 → `run_fork_equivalence_check.py` 실행 →
...
- `tasks/step_01_fork_equivalence/run_fork_equivalence_check.py` (검증 스크립트)
- `results/step_01/vastai/summary.json` (all_invariants_passed: true)
- `docs/reports/step_01_fork_equivalence_report.md`, `docs/prompts/step_01_prompt.md`
- `tasks/step_01_fork_equivalence.md` (stub → 자체완결 확장)
